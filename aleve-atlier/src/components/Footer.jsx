      ...
      <div className="footer-container">
        ...
        <div className="footer-mid">
          <div className="footer-col">
            ...
            <a className="footer-link" href="#services">Process</a>
            <a className="footer-link" href="#portfolio">Work</a>
          </div>
          <div className="footer-col">
            ...
            <a className="footer-link footer-link-icon" href="https://instagram.com/aleveatelier" target="_blank" rel="noopener noreferrer">
              <InstagramIcon />
              Instagram
            </a>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-left">
            ...
            <span className="footer-tagline">Engineered to Elevate.</span>
          </div>
          <p className="footer-copyright">&copy; {new Date().getFullYear()} Aleve Atelier. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
